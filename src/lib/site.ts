...
// not actually woodlark.com — every page that emits canonicals, OG URLs, or
// JSON-LD reads from here.
export const siteConfig = {
  name: 'Woodlark',
  tagline: 'Recon Veneer from the house of Billionply',
  description:
    'Embracing Italian excellence, crafted for the bold. Discover the collection that redefines performance and style.',
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'woodlark.com',
  whatsappNumber: '919138880121',
  whatsappDisplay: '+91 91388 80121',
  email: 'sales@billionply.com',
  address: {
    company: 'Jai Shiv Plywood Pvt Ltd',
